...
library(gridExtra)
plot1 <- ggplot(china) + geom_line(aes(x = year, y = lifeExp * 10)) + geom_line(aes(x = year, y = gdpPercap, color="red"))
plot2 <- ggplot(india) + geom_line(aes(x = year, y =  lifeExp * 10)) + geom_line(aes(x = year, y = gdpPercap, color="red"))
grid.arrange(plot1, plot2, ncol=2)
